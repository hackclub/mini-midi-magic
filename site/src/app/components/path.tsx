...
export const KitSection = () => {
  const kitItems = [
    ...
    },
    {
      ...
      rotation: "rotate-2",
      position: "top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden md:block",
    ...
    <section className="py-12 md:py-20 bg-gray-200 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-8 md:mb-16">
          ...
          <p className="text-lg md:text-xl text-amber-700">Everything you need to build your MIDI controller</p>
        </div>
